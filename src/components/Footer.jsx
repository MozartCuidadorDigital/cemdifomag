...
const Footer = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      href: 'mailto:contacto@cemdifomag.com'
    },
    {
      icon: MapPinIcon,
      label: 'Ubicación',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4 mb-4">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl px-3 py-2 min-w-[100px]">
                <img
            ...
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-400 mt-2">Cemdi FOMAG</p>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="text-center md:text-left">
              <p className="text-gray-400 text-sm">
                © {currentYear} Cemdi FOMAG. Todos los derechos reservados.
              </p>
            </div>
          </div>
        </div>
