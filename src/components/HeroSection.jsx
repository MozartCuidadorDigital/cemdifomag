      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fade-in">
          ...
          <div className="flex justify-center items-center gap-8 mb-8">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl px-6 py-3 shadow-lg hover:shadow-xl transition-shadow duration-300 min-w-[160px]">
              <img
                src="https://www.fomag.gov.co/wp-content/uploads/2025/04/Logo-color.png"
                alt="Logo FOMAG"
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-text-secondary mb-8 max-w-3xl mx-auto">
            ...
            Disponible 24/7 para programar tus consultas en Cemdi FOMAG.
          </p>
          ...
          <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-6 text-text-muted">
            ...
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
              <span className="text-sm">Cemdi FOMAG</span>
            </div>
          </div>
        </div>
      </div>
